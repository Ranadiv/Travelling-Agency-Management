...
public:
    ...
    void getDetails()
    {
        fstream out("old-customers.txt", ios::app); //open file using append mode to write customer details
        {
            cout << "\nEnter Customer ID: ";
            cin >> cusID;
            cin.ignore();
...
public:
    ...
    void hotels()
    {
        string hotelNo[] = {"Siddhartha's Hotel", "Divya's Hotel", "Shivam's Hotel"};
        for(int a = 0; a < 3; a++)
        {
        ...
        if(choiceHotel == 1){
            ...
            cout << "\tLive a Luxury at Siddhartha's Hotel: Rs.15000.00" << endl;
            ...
            if (packChoice1 == 1){
                hotelCost = 5000.00;
                cout << "\nYou have successfully booked Standard Pack at Siddhartha's Hotel" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2){
                hotelCost = 10000.00;
                cout << "\nYou have successfully booked Premium Pack at Siddhartha's Hotel" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3){
                hotelCost = 15000.00;
                cout << "\nYou have successfully booked Luxury Pack at Siddhartha's Hotel" << endl;
                cout << "Goto Menu to take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            ...
            if (packChoice1 == 1){
                hotelCost = 15000.00;
                cout << "You have successfully booked Family Pack at Divya's Hotel" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2){
                hotelCost = 10000.00;
                cout << "You have successfully booked Couple Pack at Divya's Hotel" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3){
                hotelCost = 5000.00;
                cout << "You have successfully booked Single Pack at Divya's Hotel" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            ...
            cout << "-------WELCOME TO Shivam's Hotel-------\n" << endl;
            ...
            if (packChoice1 == 1){
                hotelCost = 5000.00;
                cout << "You have successfully booked Shivam's Hotel Special Pack" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
...
public:
    ...
    void printBill()
    {
        ...
        {
            outf << "--------Blue Cloud Travel Agency--------" << endl;
            outf << "-------------Receipt-------------" << endl;
